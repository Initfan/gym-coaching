...
interface CommunityState {
  posts: Post[];
  addPost: (text: string, img?: string) => void;
...
const initialPosts: Post[] = [
  {
    ...
    authorImg: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=100",
...
export const useCommunityStore = create<CommunityState>()(
  persist(
    (set) => ({
      ...
      addPost: (text, img) => set((state) => ({
        posts: [
          {
            id: Date.now(),
            author: "You",
            authorImg: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=100",
            time: "Just now",
            text,
            img: img || "",
            likes: 0,
